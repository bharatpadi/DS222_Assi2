...
with tf.Session() as sess:
        ...
        for batch in batches:
            ...
            if i % (data_size/batch_size) == 0:
                ...
                if val_acc > max_val_acc:
                    max_val_acc = val_acc
                    #saver.save(sess, '/home/bharatp/MLLD/Ass2/models/log_reg_const_lr_0.01_2proc_23epo_' + str(proc_id) + '_' +str(val_acc))
                    #best_model_path = '/home/bharatp/MLLD/Ass2/models/log_reg_const_lr_0.01_2proc_23epo_' + str(proc_id) + '_' + str(val_acc)
        #np.save('training_loss_const_lr_0.01_2proc_23epochs_asgd_'+str(proc_id) +'.npy',np.array(t_loss))    
    ...
    for x in range(NUM_CONCURRENT_STEPS):
         pool.apply(train_function, args=(x,))
