    ...
    for batch in batches:
        ...
        if i % (data_size/batch_size) == 0:
            ...
            if val_acc > max_val_acc:
               max_val_acc = val_acc
               saver.save(sess, '/home/bharatp/MLLD/Ass2/models/log_reg_const_lr_0.01_40epo_' + str(val_acc))
               best_model_path = '/home/bharatp/MLLD/Ass2/models/log_reg_const_lr_0.01_40epo_' + str(val_acc)
...
np.save('training_loss_const_lr_0.01_23epochs.npy',np.array(t_loss))
